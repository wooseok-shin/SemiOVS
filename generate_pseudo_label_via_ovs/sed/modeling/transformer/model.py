...
class Aggregator(nn.Module):
    ...
    def correlation(self, img_feats, text_feats, logit_scale):
        # print('11', img_feats.shape, text_feats.shape)
        # quit()
        img_feats = F.normalize(img_feats, dim=1) # B C H W      // (B, 768, 24, 24)
        text_feats = F.normalize(text_feats, dim=-1) # B T P C   // (B, Num_classes=155, Num_templates=80, 768)
